...
| VPC Flow Logs, CloudTrail, ALB access logs ingested to shared S3 bucket only                  | No real-time monitoring via CloudWatch Logs Insights (which requires logs to be ingested into a CloudWatch Log Group)                                                                                                                                                                                                                                                                                |
